...
class Zip2ZipModel(nn.Module):
    def __init__(
        ...
        # self.model = Zip2ZipModelBase(self.config, self.base_model)
        # self.model.load_pretrained_hyper_encoders(zip2zip_path, torch_device=self.base_model.device)
    ...
    def forward(
        ...
        return self.model.forward(input_ids, positions, forward_batch, input_embeds, get_embedding, pp_proxy_tensors)
